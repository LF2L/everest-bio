...
# author:
# - Fabio A. Cruz Sanchez^[Université de Lorraine]
# - Nadège Troussier^[Université Technologique de Troyes]
# - Hakim Boudaoud^[Université Technologique de Troyes]
# - Mauricio Camargo^[Université Technologique de Troyes]
...
The goal of this first step is to highlight the main interactions (positive and negative) that the 
...
In the same logic, recently, the concept of distributed recycling via additive manufacturing (DRAM) emerged in the literature to face the socio-environmental challenges related to recycling option for AM technologies using plastic material as feedstock [@CruzSanchez2020; @Santander2020]. 
...
## Step II - Ecosystem services Priorities at the territorial level: Nancy, France 

Three main elements needs to be carry out in this phase: 

1) definition of the technological and ecological spheres, 2) prioritization of the territorial issues, and 3) identification of the industrial issues.




## Step II - Identifying the Hot spot of the 

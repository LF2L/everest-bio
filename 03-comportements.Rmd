...
mermaid("
graph LR
  A[\"Attitude toward the act (Att)\"]-->D[Behavioural Intention]
  B[\"Subjective Norm (SN)\"]-->D[Behavioural Intention]
  C[\"Perceived Behavioural Control (PBC)\"]-->D[Behavioural Intention]
  D[Behavioural Intention]-->E[Behaviour]
  C[Perceived Behavioural Control]-.->E[Behaviour]
  
  classDef className font-size:20px;

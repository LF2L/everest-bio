...
---
background-image: url(`r paste0(URL, 'Everest-bio/ipad/Articulo-6.jpg')`)
background-position: 50% 100%
background-size: 55%
...
---
background-image: url(`r paste0(URL, 'Ecoservices/CICES/Potschin-Burkhard2017.png')`)
background-position: 1-90%% 80%
background-size: 60%

### Ecosystem Services as a **boundary object** for sustainability

.footnote[
La Notte, A., D’Amato, D., Mäkinen, H., Paracchini, M.L., Liquete, C., Egoh, B., Geneletti, D., Crossman, N.D., 2017. Ecosystem services classification: A systems ecology perspective of the cascade framework. Ecol. Indic. 74, 392–402. https://doi.org/10.1016/j.ecolind.2016.11.030
]

---
background-image: url(`r paste0(URL, 'Ecoservices/Vanderwilde2021-00.jpg')`)
...
class: top, left
background-image: url(`r paste0(URL, 'Ecoservices/Kumar2021.jpg')`)
background-position: 50% 50%
background-size: 80% 


### Ecosystem services and the global value chain of plastic

.footnote[
Kumar, Rakesh, Verma, A., Shome, A., Sinha, R., Sinha, S., Jha, P.K., Kumar, Ritesh, Kumar, P., Shubham, Das, S., Sharma, P., Vara Prasad, P. V., 2021. Impacts of Plastic Pollution on Ecosystem Services, Sustainable Development Goals, and Need to Focus on Circular Economy and Policy Interventions. Sustainability 13, 9963. https://doi.org/10.3390/su13179963
]
...
class: top, left
background-image: url(`r paste0(URL, 'Ecoservices/FR/efese.png')`)
background-position: 50% 50%
background-size: 80% 

### Ecosystem services and Territorial issues
